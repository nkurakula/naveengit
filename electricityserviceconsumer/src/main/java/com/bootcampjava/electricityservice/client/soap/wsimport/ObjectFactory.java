 ...
 * generated in the com.bootcampjava.electricityservice.client.soap.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServicePlan_QNAME = new QName("http://soapserv.service.soaputilplan.customerutilityws.txuenergy.com/", "getServicePlan");
    private final static QName _GetServicePlanResponse_QNAME = new QName("http://soapserv.service.soaputilplan.customerutilityws.txuenergy.com/", "getServicePlanResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bootcampjava.electricityservice.client.soap.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserv.service.soaputilplan.customerutilityws.txuenergy.com/", name = "getServicePlan")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserv.service.soaputilplan.customerutilityws.txuenergy.com/", name = "getServicePlanResponse")
